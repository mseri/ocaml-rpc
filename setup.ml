...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5c7519af24982e5b9830516f51219908) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the JS client";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "rpclib";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "ppx_deriving_rpc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving.api", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Ppx_deriving_rpc"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ppx_deriving_rpc";
                      lib_findlib_containers = []
                   })
            ];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\133\201.\023\187\006s\250\254\191$\219\13786\228";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
